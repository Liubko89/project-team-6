import"./assets/quote-dd45c8a3.js";import{a as g,i as M}from"./assets/vendor-db25513e.js";g.defaults.baseURL="https://energyflow.b.goit.study/api";let H=document.getElementById("scrollToTopBtn");window.onscroll=function(){ce()};function ce(){document.body.scrollTop>20||document.documentElement.scrollTop>20?H.style.display="block":H.style.display="none"}H.addEventListener("click",oe);function oe(){document.body.scrollTop=0,document.documentElement.scrollTop=0}const Z=document.querySelector(".exercises-nav-list"),ee=document.querySelector(".exercises-container"),J=document.querySelector(".exercise-group"),E=document.querySelector(".pagination"),le="https://energyflow.b.goit.study/api";let F="Muscles";Z.addEventListener("click",de);E.addEventListener("click",fe);N(F).then(_);async function de(e){const{filter:t}=e.target.dataset;if(!t)return;F=t,await N(t).then(_);const s=Z.querySelector(".active"),a=e.target;s.classList.remove("active"),a.classList.add("active")}async function N(e,t=1){return fetch(`${le}/filters?filter=${e}&page=${t}&limit=12`).then(s=>s.json())}function _({results:e,page:t,totalPages:s}){ue(e),me(s,t)}function ue(e){ee.innerHTML=e.map(pe).join("")}function pe({name:e,filter:t,imgUrl:s}){return`
  ...
  `}function fe(e){var s;const t=(s=e.target.closest(".page"))==null?void 0:s.dataset.page;t&&N(F,t).then(_)}ee.addEventListener("click",ve);function ve(e){const s=e.target.closest(".exercise-card");if(!s)return;const a=s.querySelector(".description-category").textContent;return J.textContent=a,J.textContent}const c="/project-team-6/assets/icons-66c1ea1d.svg";document.querySelector(".exercises-nav-list");const R=document.querySelector(".fetch-container"),he=document.querySelector(".exercises-container");document.querySelector(".exercise-card");const xe=document.querySelector(".exercises-gallery");document.querySelector(".header-box");const V=document.querySelector(".exercises-search"),j=document.querySelector(".exercises-toolbar");document.getElementById("muscles-button");const l=document.querySelector(".pagination-exercises"),L=innerWidth<1440?8:9,ye=document.querySelector(".search-container"),K=document.querySelector(".form-search"),z=document.querySelector(".span-exercises "),be=document.querySelector(".exercise-group");let C,q,$,S;l.addEventListener("click",qe);const Ee="https://energyflow.b.goit.study/api/",Le={Muscles:"muscles","Body parts":"bodypart",Equipment:"equipment"},o="is-hidden";he.addEventListener("click",$e);R.classList.remove(o);j.classList.add(o);async function $e(e){const t=e.target.closest(".exercise-card");if(!t)return;const{filter:s,group:a,page:r}=t.dataset;$=s,S=a,await Se(Le[s],a).then(te),R.classList.add(o),j.classList.remove(o),V.addEventListener("click",n),K.classList.remove(o),z.classList.remove(o);function n(i){console.log(i.target),i.currentTarget===V&&(R.classList.remove(o),j.classList.add(o),K.classList.add(o),z.classList.add(o),ye.classList.add(o),be.textContent="")}}async function Se(e,t){return fetch(`${Ee}exercises?${e}=${t}&limit=1e6`).then(s=>s.json()).then(s=>{C=s.results})}function O({bodyPart:e,target:t,name:s,burnedCalories:a,rating:r,time:n,_id:i}){return`<li class = "list-exercises" id="${i}" data-filter="${s}"><div class="options">
  <div class="box-up">
  <div class="box-left">
